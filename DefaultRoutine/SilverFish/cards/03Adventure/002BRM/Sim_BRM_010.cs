...
namespace SilverFish.cards._03Adventure._002BRM
{
    class Sim_BRM_010 : SimTemplate //* Druid of the Flame
    {
        ...
        CardDB.Card fireCat52 = CardDB.Instance.getCardDataFromID(CardIdEnum.BRM_010t);
        CardDB.Card fireHawk25 = CardDB.Instance.getCardDataFromID(CardIdEnum.BRM_010t2);
        CardDB.Card CatHawk55 = CardDB.Instance.getCardDataFromID(CardIdEnum.OG_044b);
